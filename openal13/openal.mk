...
WorkspacePath          := "C:\Program Files\CodeLite\openal"
ProjectPath            := "F:\openal-soft-1.13"
CurrentFileName        :=
CurrentFilePath        :=
CurrentFileFullPath    :=
User                   :=shanfl
...
ObjectsFileList        :="F:\openal-soft-1.13\openal.txt"
PCHCompileFlags        :=
...
$(OutputFile): $(Objects)
	...
	@$(MakeDirCommand) "C:\Program Files\CodeLite\openal\.build-debug"
	@echo rebuilt > "C:\Program Files\CodeLite\openal\.build-debug\openal"
...
clean:
	...
	$(RM) $(OutputFile)
	$(RM) $(OutputFile)
	$(RM) "C:\Program Files\CodeLite\openal\.build-debug\openal"
